...
namespace LandscapeWebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(LandscapeProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Name,Email,Phone,Address,Role,CreatedAt,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Name,Email,Phone,Address,Role,CreatedAt,Password")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> BulkDeleteUsers(List<int> userIds)
        {
            if (userIds == null || userIds.Count == 0)
            {
                ...
                return RedirectToAction("BulkDeleteUsers");
            }
            ...
            {
                TempData["ErrorMessage"] = "Users not found.";
            }
